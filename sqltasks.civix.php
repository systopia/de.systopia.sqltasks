 ...
 */
function _sqltasks_civix_civicrm_xmlMenu(&$files) {
  foreach (_sqltasks_civix_glob(__DIR__ . '/xml/Menu/*.xml') as $file) {
    $files[] = $file;
  }
}
 ...
 */
function _sqltasks_civix_civicrm_uninstall() {
  _sqltasks_civix_civicrm_config();
  if ($upgrader = _sqltasks_civix_upgrader()) {
 ...
 */
function _sqltasks_civix_civicrm_enable() {
  _sqltasks_civix_civicrm_config();
  if ($upgrader = _sqltasks_civix_upgrader()) {
 ...
 * @return mixed
 */
function _sqltasks_civix_civicrm_disable() {
  _sqltasks_civix_civicrm_config();
  if ($upgrader = _sqltasks_civix_upgrader()) {
 ...
 * @return array
 */
function _sqltasks_civix_find_files($dir, $pattern) {
  ...
  while (!empty($todos)) {
    ...
    foreach (_sqltasks_civix_glob("$subdir/$pattern") as $match) {
      if (!is_dir($match)) {
        $result[] = $match;
      }
    }
 ...
 */
function _sqltasks_civix_civicrm_managed(&$entities) {
  $mgdFiles = _sqltasks_civix_find_files(__DIR__, '*.mgd.php');
  sort($mgdFiles);
 ...
 */
function _sqltasks_civix_civicrm_caseTypes(&$caseTypes) {
  if (!is_dir(__DIR__ . '/xml/case')) {
    return;
  }

  foreach (_sqltasks_civix_glob(__DIR__ . '/xml/case/*.xml') as $file) {
 ...
 */
function _sqltasks_civix_civicrm_angularModules(&$angularModules) {
  if (!is_dir(__DIR__ . '/ang')) {
    return;
  }

  $files = _sqltasks_civix_glob(__DIR__ . '/ang/*.ang.php');
 ...
 */
function _sqltasks_civix_civicrm_themes(&$themes) {
  $files = _sqltasks_civix_glob(__DIR__ . '/*.theme.php');
  foreach ($files as $file) {
 ...
 * @return array
 */
function _sqltasks_civix_glob($pattern) {
  $result = glob($pattern);
 ...
 */
function _sqltasks_civix_civicrm_alterSettingsFolders(&$metaDataFolders = NULL) {
