...
// Make CRM_Sqltasks_ExtensionUtil available.
require_once __DIR__ . '/../../sqltasks.civix.php';
...
addExtensionToClassLoader('de.systopia.sqltasks');
 ...
 */
function _sqltasks_test_civicrm_container(ContainerBuilder $container): void {
}
